...
# Default MPI Vars
DEF_MPI_URL=https://download.open-mpi.org/release/open-mpi/v3.1/openmpi-3.1.0.tar.gz
DEF_MPI_TAR=openmpi-3.1.0.tar.gz
DEF_MPI_DIR=openmpi-3.1.0
...
./configure --with-cuda --prefix=$DEF_MPI_BUILD >&2
make -j >&2
make install >&2
